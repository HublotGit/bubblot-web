/*********************************************************************
 *
 * $Id: yocto_currentloopoutput.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_LOOPPOWER_NOPWR               = 0;
export var Y_LOOPPOWER_LOWPWR              = 1;
export var Y_LOOPPOWER_POWEROK             = 2;
export var Y_LOOPPOWER_INVALID             = -1;
export var Y_CURRENT_INVALID               = YAPI.INVALID_DOUBLE;
export var Y_CURRENTTRANSITION_INVALID     = YAPI.INVALID_STRING;
export var Y_CURRENTATSTARTUP_INVALID      = YAPI.INVALID_DOUBLE;
...
export class YCurrentLoopOutput extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YCurrentLoopOutputProxy(this);
...
export class YCurrentLoopOutputProxy extends YFunctionProxy
{
