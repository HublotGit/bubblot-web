/*********************************************************************
 *
 * $Id: yocto_wakeupschedule.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_MINUTESA_INVALID              = YAPI.INVALID_UINT;
export var Y_MINUTESB_INVALID              = YAPI.INVALID_UINT;
export var Y_HOURS_INVALID                 = YAPI.INVALID_UINT;
export var Y_WEEKDAYS_INVALID              = YAPI.INVALID_UINT;
export var Y_MONTHDAYS_INVALID             = YAPI.INVALID_UINT;
export var Y_MONTHS_INVALID                = YAPI.INVALID_UINT;
export var Y_NEXTOCCURENCE_INVALID         = YAPI.INVALID_LONG;
...
export class YWakeUpSchedule extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YWakeUpScheduleProxy(this);
...
export class YWakeUpScheduleProxy extends YFunctionProxy
{
