(function () {
    ...
    angular
        .module('bubblot')
        .controller('winderPanel2Ctrl', winderPanel2Ctrl);

    function winderPanel2Ctrl($scope) {
        var vm = this;
        var winderLength=document.getElementsByClassName("winder2");
        var minPressure=document.getElementsByClassName("min-pressure2"); 
        ...
        var cadranWinderPanel=document.getElementsByClassName('cadrans-winder-container winder-panel left-two');
