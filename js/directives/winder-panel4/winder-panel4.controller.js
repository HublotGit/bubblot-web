(function () {
    ...
    angular
        .module('bubblot')
        .controller('winderPanel4Ctrl', winderPanel4Ctrl);

    function winderPanel4Ctrl($scope) {
        var vm = this;
        var winderLength=document.getElementsByClassName("winder4");
        var minPressure=document.getElementsByClassName("min-pressure4"); 
        ...
        var cadranWinderPanel=document.getElementsByClassName('cadrans-winder-container winder-panel right-two');
